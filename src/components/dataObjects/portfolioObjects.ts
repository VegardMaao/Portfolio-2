...
const semesterProject2: portfolioItem = createPortfolioItem("Semester Project 2", "src/assets/images/thumbnails/semester-project-2-thumbnail.png", "My semester project 2, update this later", "https://github.com/VegardMaao/semester-project-2", "https://noroff-aucthion-house.netlify.app")
